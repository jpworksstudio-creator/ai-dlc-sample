...
| FR-1 | 機能要件 | Zaim エクスポート取り込み | S-1 | | Pending |
| FR-2 | 機能要件 | Moneytree エクスポート取り込み | S-2 | | Pending |
| FR-3 | 機能要件 | ブラウザローカルのみ保存 | S-1, S-2, S-8, NFR-5 | | Pending |
| FR-4 | 機能要件 | 自然言語での AI 質問 | S-3 | | Pending |
...
| FR-10 | 機能要件 | 取り込みデータの削除 | S-8 | | Pending |
| S-1 | ストーリー | Zaim エクスポート取り込み | SCR-1, SCR-2 | | Pending |
| S-2 | ストーリー | Moneytree エクスポート取り込み | SCR-1, SCR-2 | | Pending |
| S-3 | ストーリー | 自然言語での AI 質問 | SCR-1, SCR-3 | | Pending |
...
| NFR-2 | 非機能要件 | 30秒以内応答（SM-1） | FR-5 | | Pending |
| NFR-3 | 非機能要件 | カテゴリ金額±10%（SM-2） | FR-6 | | Pending |
| NFR-4 | 非機能要件 | 改善案＋良かった点（SM-3） | FR-8, FR-9 | | Pending |
| NFR-5 | 非機能要件 | 端末外への永続送信なし | FR-3 | | Pending |
