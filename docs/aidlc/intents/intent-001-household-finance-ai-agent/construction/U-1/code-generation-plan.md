...
| L-2 | localStorage、ドメインモデル、DatasetSummary | FR-3, NFR-5, S-3 前提 | 6 files | Vitest 2件 | Pending |
| L-3 | Zaim CSV 取り込み、カテゴリ正規化、取り込み画面 | S-1, FR-1, NFR-3 | 7 files | Vitest 2件 + fixture | Pending |
| L-4 | `/api/chat`、OpenAI 連携、チャット UI、`.env.example` | S-3〜S-7, FR-4〜9 | 8 files | Vitest 2件 | Pending |
| L-5 | 設定画面、全データ削除 | S-8, FR-10 | 5 files | Vitest 1件 | Pending |
